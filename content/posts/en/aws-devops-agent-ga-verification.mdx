...
> On instance i-09329356f21adb8a5, the command `stress-ng --cpu 2 --timeout 600` was executed via Systems Manager at 2026-04-01 00:42:09 UTC. Since the t3.micro instance has 2 vCPUs, stress-ng fully utilizing both CPUs is the direct cause of the 100% CPU utilization.
