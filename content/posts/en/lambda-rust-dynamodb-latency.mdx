---
title: "Lambda Rust — How Much Does the 90x DynamoDB Speed Gap Shrink in Real Workloads?"
...
<details className="my-4 rounded-lg border border-border bg-muted/30 p-4">
<summary className="cursor-pointer font-medium">Benchmark execution steps (cold start measurement)</summary>

```bash title="Terminal (cold start measurement)"
REGION="ap-northeast-1"
...
<details className="my-4 rounded-lg border border-border bg-muted/30 p-4">
<summary className="cursor-pointer font-medium">Benchmark execution steps (warm start measurement)</summary>

```bash title="Terminal (warm start measurement)"
REGION="ap-northeast-1"
