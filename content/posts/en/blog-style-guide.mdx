...
Below, I explain the *reasoning* behind each rule rather than the rules themselves. For the full rules, see [CLAUDE.md](https://github.com/shinyaz/shinyaz.com/blob/main/CLAUDE.md).
