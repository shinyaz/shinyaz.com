---
title: "Verifying AWS Security Agent Code Remediation — Auto-Generated PRs for Pentest Findings"
...
- **GitHub integration required** — Install the AWS Security Agent GitHub App and connect repositories to the Agent Space
- **Private repos → PR creation, Public repos → downloadable diff file**
