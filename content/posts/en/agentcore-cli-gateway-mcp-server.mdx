...
[Part 1](/en/blog/2026/03/23/agentcore-cli-create-dev-deploy) covered the basic lifecycle, [Part 2](/en/blog/2026/03/23/agentcore-cli-memory-persistence) covered Memory persistence. This time we connect an external MCP server to an agent using Gateway.
...
In `main.py`, `get_all_gateway_mcp_clients()` replaces the default `get_streamable_http_mcp_client()` from [Part 1](/en/blog/2026/03/23/agentcore-cli-create-dev-deploy).
