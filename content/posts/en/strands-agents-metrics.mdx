...
Use the same environment from [Part 1](/en/blog/2026/04/03/strands-agents-structured-output). All examples use the same model configuration and can be run as independent `.py` files. Write the common setup at the top, then add each example's code below.
...
|---|---|---|
| [Part 1](/en/blog/2026/04/03/strands-agents-structured-output) | Structured Output | Type-safe output with Pydantic, automatic validation retries |
| [Part 2](/en/blog/2026/04/03/strands-agents-session-management) | Session Management | Conversation persistence and restoration with FileSessionManager |
| [Part 3](/en/blog/2026/04/03/strands-agents-hooks) | Hooks | Tool call monitoring, limiting, and result modification |
| [Part 4](/en/blog/2026/04/03/strands-agents-guardrails) | Guardrails | Input/output filtering and shadow mode |
