---
title: "Verifying AWS DevOps Agent — What Proactive Prevention Actually Recommends"
description: "Fed multiple incident investigation patterns to DevOps Agent's Proactive Prevention and ran a manual evaluation. Examined the generated Recommendation's content, category, and Agent-ready Specification availability to reveal what prevention proposals look like in practice."
date: "2026-04-01"
published: true
featured: false
...
[Part 1](/en/blog/2026/04/01/aws-devops-agent-ga-verification) covered DevOps Agent setup and incident investigation. [Part 2](/en/blog/2026/04/01/aws-devops-agent-custom-skills) explored how Custom Skills improve investigation quality. Both focused on post-incident response.

DevOps Agent has another pillar. **Proactive Prevention** analyzes past incident investigations to generate improvement recommendations. By default, evaluations run automatically on a weekly schedule, but can also be triggered manually. It's accessible from the "Prevention" page in the Operator Web App.
...
Proactive Prevention evaluation requires incident investigation history to analyze. Parts 1 and 2 produced 2 CPU spike investigations (both stress-ng), which are too homogeneous for diverse recommendations.
...
I clicked "Run Now" on the "Prevention" page in the Operator Web App.
...
I fed 8 incident investigations (3 patterns: CPU spike, memory exhaustion, disk space exhaustion) to Proactive Prevention and ran 3 manual evaluations.
...
- [Part 2](/en/blog/2026/04/01/aws-devops-agent-custom-skills): Custom Skills for investigation quality — structured report format and reduced investigation time
- Part 3 (this article): Proactive Prevention — generated specific improvement recommendations from past investigations
