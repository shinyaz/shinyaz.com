---
title: "EKS ArgoCD Capability — Build a Managed GitOps Environment with AWS CLI"
...
```json title="argocd-trust-policy.json"
{
  "Version": "2012-10-17",
  "Statement": [
    {
