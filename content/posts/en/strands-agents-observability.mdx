...
From [part 1](/en/blog/2026/04/18/strands-agents-docker) through [part 3](/en/blog/2026/04/18/strands-agents-agentcore), we deployed agents to Docker, Lambda, and AgentCore. The deployment target is set, but production operation needs one more thing: a way to monitor agent behavior.
...
- The [part 1](/en/blog/2026/04/18/strands-agents-docker) environment (`strands-agents` installed)
