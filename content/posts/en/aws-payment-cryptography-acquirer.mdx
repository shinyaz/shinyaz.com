...
The verification tampers the original message `48656C6C6F576F726C64` ("HelloWorld") by changing the last byte from `64` to `65`. Even this single byte change causes MAC verification to fail, detecting any data tampering during transmission.
