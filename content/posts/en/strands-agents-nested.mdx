...
In [Part 1](/en/blog/2026/04/11/strands-agents-swarm) we learned Swarm's autonomous collaboration, and in [Part 2](/en/blog/2026/04/11/strands-agents-graph) we learned Graph's structured workflows. But real tasks often need both: "research should be autonomous collaboration among specialists, while the overall flow should be structured."
...
Use the same environment from [Part 1](/en/blog/2026/04/11/strands-agents-swarm). All examples use the same model configuration and can be run as independent `.py` files. Write the common setup at the top, then add each example's code below it.
