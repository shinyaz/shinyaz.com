...
From the [introductory series](/en/blog/2026/03/03/strands-agents-quickstart) through the [multi-agent series](/en/blog/2026/04/11/strands-agents-swarm), every agent ran as a local Python script. `python agent.py` works, but other systems can't call it.
