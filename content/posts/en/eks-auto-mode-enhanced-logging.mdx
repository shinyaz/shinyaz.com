...
In the [previous post](/en/post/eks-auto-mode-cluster-setup), I covered building an EKS cluster with Auto Mode. While Auto Mode conveniently delegates node management to EKS, the "what's happening under the hood" question remains.
