...
[Part 1](/en/blog/2026/03/23/agentcore-cli-create-dev-deploy) covered the basic lifecycle, [Part 2](/en/blog/2026/03/23/agentcore-cli-memory-persistence) covered Memory, [Part 3](/en/blog/2026/03/23/agentcore-cli-gateway-mcp-server) covered Gateway. In this final installment, we measure agent response quality using Evaluations.
