...
Use the same environment from [Part 1](/en/blog/2026/04/11/strands-agents-swarm). All examples use the same model configuration. Write the common setup at the top, then add each example's code below it.
...
The pattern from [Part 1](/en/blog/2026/04/11/strands-agents-swarm). Agents autonomously hand off to each other.
...
The pattern from [Part 2](/en/blog/2026/04/11/strands-agents-graph). Execution order explicitly defined by edges.
...
| [Practical](/en/blog/2026/04/03/strands-agents-structured-output) (5 parts) | Quality | Structured Output, sessions, Hooks, Guardrails, metrics |
| [Multi-Agent](/en/blog/2026/04/11/strands-agents-swarm) (4 parts) | Collaboration | Swarm, Graph, nesting+Hooks+shared state, pattern comparison |
