...
In the [previous articles](/en/blog/2026/03/03/strands-agents-mcp-tools), we extended what agents can do with custom tools and MCP. But every example so far was a single-shot call. Practical agents need the ability to carry on a conversation.
...
Use the same environment from the [previous article](/en/blog/2026/03/03/strands-agents-mcp-tools).
