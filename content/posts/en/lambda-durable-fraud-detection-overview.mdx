...
- **[Part 2](/en/blog/2026/03/30/lambda-durable-fraud-detection-best-practices)**: Hands-on verification of 6 best practices
- **[Part 3](/en/blog/2026/03/30/lambda-durable-fraud-detection-operations)**: Deploy, test, and operations insights
...
`ExecutionTimeout: 90000` (25 hours) is intentionally set slightly above the 24-hour callback timeout. The design rationale is covered in [Part 2](/en/blog/2026/03/30/lambda-durable-fraud-detection-best-practices).
...
Next up: [Part 2](/en/blog/2026/03/30/lambda-durable-fraud-detection-best-practices) verifies the six best practices from the blog post using this demo.
