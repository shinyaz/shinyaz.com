...
Use the same environment from [Part 1](/en/blog/2026/03/29/strands-agents-structured-output). All examples use the same model configuration and can be run as independent `.py` files. Write the common setup at the top, then add each example's code below it.
