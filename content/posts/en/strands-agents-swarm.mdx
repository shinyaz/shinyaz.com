...
In the [introductory series](/en/blog/2026/03/03/strands-agents-quickstart) we learned agent basics, and in the [practical series](/en/blog/2026/03/29/strands-agents-structured-output) we learned output control and behavior monitoring. In Part 5 of the intro series, we used the [Agents as Tools](/en/blog/2026/03/03/strands-agents-multi-agent) pattern to coordinate multiple agents, but that pattern had the orchestrator controlling everything.
