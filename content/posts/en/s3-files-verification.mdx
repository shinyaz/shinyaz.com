---
title: "Measuring S3 Files Sync Latency and Read Performance on a Real NFS Mount"
...
```mermaid
flowchart LR
    R[Read request] --> C{File size}
    C -->|≤ 128KB| H[High-performance storage<br/>Low latency ⚡]
    C -->|≥ 1MB| S[Direct from S3 bucket<br/>High throughput 📦]
    H --> CL[NFS client]
    S --> CL
```
