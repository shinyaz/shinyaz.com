...
AgentCore Runtime also offers a [Code Interpreter](https://docs.aws.amazon.com/bedrock-agentcore/latest/devguide/code-interpreter-tool.html). Despite the similar naming, the two serve distinct roles.
