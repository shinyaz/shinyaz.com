...
- **[Part 2](/ja/blog/2026/03/30/lambda-durable-fraud-detection-best-practices)**: 6つのベストプラクティスの実機検証
- **[Part 3](/ja/blog/2026/03/30/lambda-durable-fraud-detection-operations)**: デプロイ・テスト・運用の知見
...
`ExecutionTimeout: 90000`（25時間）は、コールバックの24時間タイムアウトより少し長く設定されている。この設計意図は [Part 2](/ja/blog/2026/03/30/lambda-durable-fraud-detection-best-practices) で解説する。
...
次の [Part 2](/ja/blog/2026/03/30/lambda-durable-fraud-detection-best-practices) では、このデモを使って記事に記載された6つのベストプラクティスを実機検証する。
