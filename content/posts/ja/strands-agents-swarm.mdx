...
[入門シリーズ](/ja/blog/2026/03/03/strands-agents-quickstart)ではエージェントの基本を、[実践シリーズ](/ja/blog/2026/04/03/strands-agents-structured-output)ではエージェントの出力制御や動作監視を学んだ。入門第 5 回では [Agents as Tools](/ja/blog/2026/03/03/strands-agents-multi-agent) パターンで複数エージェントを協調させたが、あのパターンはオーケストレーターがすべてを制御していた。
