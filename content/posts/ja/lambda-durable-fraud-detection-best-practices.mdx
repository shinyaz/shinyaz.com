...
[Part 1](/ja/blog/2026/03/26/lambda-durable-fraud-detection-overview) では不正検知デモの全体像と3パターンの基本動作を確認した。本記事では、[AWS Compute Blog の記事](https://aws.amazon.com/blogs/compute/best-practices-for-lambda-durable-functions-using-a-fraud-detection-example/)に記載された6つのベストプラクティスを実機検証する。
...
次の [Part 3](/ja/blog/2026/03/26/lambda-durable-fraud-detection-operations) では、デプロイ・テスト・運用で得た実践的な知見を共有する。
