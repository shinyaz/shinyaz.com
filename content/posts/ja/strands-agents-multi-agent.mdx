...
[前回の記事](/ja/blog/2026/03/24/strands-agents-conversation)では会話の記憶とコンテキスト管理を学んだ。ここまでのシリーズで、単一エージェントの機能はほぼ網羅した。
...
[前回の記事](/ja/blog/2026/03/24/strands-agents-conversation)の環境をそのまま使う。
...
| 回 | テーマ | 学んだこと |
|---|---|---|
| [第 1 回](/ja/blog/2026/03/24/strands-agents-quickstart) | Quickstart | エージェントループ、`@tool`、メトリクス |
| [第 2 回](/ja/blog/2026/03/24/strands-agents-custom-tools) | カスタムツール | マルチステップ、エラー処理、システムプロンプト |
| [第 3 回](/ja/blog/2026/03/24/strands-agents-mcp-tools) | MCP | 外部ツール接続、自作ツールとの併用 |
| [第 4 回](/ja/blog/2026/03/24/strands-agents-conversation) | 会話管理 | マルチターン、SlidingWindow |
