...
[第 1 回](/ja/blog/2026/04/18/strands-agents-docker)から[第 3 回](/ja/blog/2026/04/18/strands-agents-agentcore)まで、エージェントを Docker、Lambda、AgentCore にデプロイした。デプロイ先は決まったが、本番運用にはもう 1 つ必要なものがある。エージェントの動作を監視する仕組みだ。
...
- [第 1 回](/ja/blog/2026/04/18/strands-agents-docker)の環境（`strands-agents` インストール済み）
