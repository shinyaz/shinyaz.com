...
[入門シリーズ](/ja/blog/2026/03/03/strands-agents-quickstart)から[マルチエージェント編](/ja/blog/2026/04/11/strands-agents-swarm)まで、エージェントはすべてローカルの Python スクリプトとして実行してきた。`python agent.py` で動くが、他のシステムから呼び出すことはできない。
