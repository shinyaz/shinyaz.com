...
[第1回](/ja/blog/2026/03/23/agentcore-cli-create-dev-deploy)では基本ライフサイクル、[第2回](/ja/blog/2026/03/23/agentcore-cli-memory-persistence)では Memory、[第3回](/ja/blog/2026/03/23/agentcore-cli-gateway-mcp-server)では Gateway を検証した。シリーズ最終回の今回は、Evaluations を使ってエージェントの応答品質を計測する。
