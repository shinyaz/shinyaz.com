...
description: Pre-deployment verification workflow. Runs lint, type check, unit tests, build, and E2E tests in sequence. Use before merging feature branches, deploying to production, or when the user wants a full validation pass.
---
