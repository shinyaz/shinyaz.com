...
description: Troubleshoot and fix Next.js build errors including Velite content generation, TypeScript compilation, Turbopack, and memory issues. Use when npm run build fails, next build errors appear, the user reports build errors, Vercel deployment breaks, or any build-related error message is encountered.
---
