---
name: fix-lint
description: Fix ESLint and Prettier linting and formatting errors. Use when lint checks fail, before committing code, or when the user mentions lint errors, formatting issues, or code style problems.
---
