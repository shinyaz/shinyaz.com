...
description: Analyze and optimize project.md and skill files for quality, conciseness, and adherence to best practices. Generates reports and applies improvements. Use when project.md grows beyond 100 lines, after adding new skills, when reviewing agent instruction quality, or when the user mentions optimizing, analyzing, or auditing skills or project.md.
---

Analyze and optimize agent instructions (project.md and skills): $ARGUMENTS
...
- [ ] Phase 2: Optimize — project.md, skills, descriptions
...
See [project.md standards](references/QUALITY-STANDARDS.md#claudemd-standards) for target sizes and content flags.
...
4. **Update project.md** — Remove migrated content, add skill references
...
```bash
wc -l project.md  # Target: under 100 (ideally under 50)
