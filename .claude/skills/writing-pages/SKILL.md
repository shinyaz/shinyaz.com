---
name: writing-pages
description: Static page writing guidelines and creation workflow. Covers frontmatter, route setup, bilingual parity, and MDX content structure. Use when the user wants to add a new page like about, uses, colophon, or any standalone page, edits files in content/pages/, or asks about page creation workflow.
---
